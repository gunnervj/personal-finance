...
### Colors
Supports only dark mode. Colors are going to be purple and blue tones with deep black. 
...
### Tables
Tables should be rounded and have a nice shadow. Tables shall be scrollable.
